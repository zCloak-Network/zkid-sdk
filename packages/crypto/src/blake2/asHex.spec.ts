...
describe('blake2AsHex', (): void => {
  ...
  it('returns a 64-bit value (specified)', (): void => {
    expect(blake2AsHex('abc', 64, null)).toEqual('0xd8bb14d833d59559');
  });

  it('returns a 128-bit value (as specified)', (): void => {
    expect(blake2AsHex('abc', 128, null)).toEqual('0xcf4ab791c62b8d2b2109c90275287816');
  });
