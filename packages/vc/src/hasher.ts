...
import { blake2AsU8a, blake3AsU8a, keccak256AsU8a, keccak512AsU8a, rescueAsU8a, sha256AsU8a, sha512AsU8a } from '@zcloak/crypto';
...
export const HASHER = {
  ...
  Blake3: (data: Uint8Array | HexString | string, bitLength?: 64 | 128 | 256 | 384 | 512, key?: Uint8Array | null) => blake3AsU8a(data, bitLength, key),
