...
describe('test is functions', (): void => {
  it('is proof object', (): void => {
    expect(
      isProof({
        type: 'EcdsaSecp256k1Signature2019',
        created: 1668362768979,
  ...
  it('is vp object', (): void => {
    expect(
      isVP({
        '@context': ['https://www.w3.org/2018/credentials/v1'],
        version: '0',
        type: ['VP'],
        verifiableCredential: [fullVC],
        id: '0xc79824e312467b9d38f5448aef37791ac9d45e5c66267eb19f327005a45fb3d4',
        proof: {
          type: 'EcdsaSecp256k1Signature2019',
          created: 1668362768979,
          verificationMethod: 'did:zk:0x565ee4a279Ad611010DF17082220987CcaD381fb#key-0',
