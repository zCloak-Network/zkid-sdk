...
describe('ed25519PairFromSeed', (): void => {
  ...
  const RESULT = {
    publicKey: new Uint8Array([
      0x2f, 0x8c, 0x61, 0x29, 0xd8, 0x16, 0xcf, 0x51, 0xc3, 0x74, 0xbc, 0x7f, 0x08, 0xc3, 0xe6, 0x3e, 0xd1, 0x56, 0xcf,
      0x78, 0xae, 0xfb, 0x4a, 0x65, 0x50, 0xd9, 0x7b, 0x87, 0x99, 0x79, 0x77, 0xee
    ]),
  ...
  it('generates a valid publicKey/secretKey pair (u8a)', (): void => {
    expect(ed25519PairFromSeed(TEST)).toEqual(RESULT);
  });
});
