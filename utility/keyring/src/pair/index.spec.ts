...
export function hashMessage(message: HexString | Uint8Array): Uint8Array {
  ...
  return u8aConcat(stringToU8a('\x19Ethereum Signed Message:\n'), stringToU8a(String(messageU8a.length)), message);
}
...
const KEYPAIR_ECDSA: Keypair = {
  ...
  publicKey: new Uint8Array([
    2, 73, 127, 28, 162, 129, 114, 146, 80, 141, 203, 39, 86, 139, 211, 3, 70, 101, 96, 27, 138, 82, 53, 70, 140, 193,
    77, 203, 22, 198, 108, 197, 55
  ])
};

const KEYPAIR_ED25519: Keypair = {
  secretKey: new Uint8Array([
    75, 155, 112, 151, 106, 167, 149, 167, 3, 2, 115, 76, 88, 47, 182, 137, 157, 138, 181, 238, 158, 142, 219, 131, 236,
    238, 38, 97, 168, 163, 193, 14, 103, 141, 192, 0, 208, 56, 166, 161, 173, 131, 158, 229, 242, 236, 250, 183, 155,
    122, 194, 21, 226, 52, 183, 84, 2, 158, 119, 218, 113, 244, 63, 132
  ]),
  publicKey: new Uint8Array([
    103, 141, 192, 0, 208, 56, 166, 161, 173, 131, 158, 229, 242, 236, 250, 183, 155, 122, 194, 21, 226, 52, 183, 84, 2,
    158, 119, 218, 113, 244, 63, 132
  ])
};
